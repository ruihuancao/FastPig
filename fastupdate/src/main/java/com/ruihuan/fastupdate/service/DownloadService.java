package com.ruihuan.fastupdate.service;
...
import com.ruihuan.fastupdate.R;
...
//            channel.setVibrationPattern(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
    ...
    private void startDownload(UpdateAppBean updateApp, final DownloadCallback callback) {
        ...
        updateApp.getIUpdateHttp().download(apkUrl, target, appName, new FileDownloadCallBack(callback));
    }
    ...
    class FileDownloadCallBack implements IUpdateHttp.FileCallback {
