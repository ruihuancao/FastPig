...
public class UpdateAppManager {
    ...
    private IUpdateHttp mIUpdateHttp;
    ...
    private UpdateAppManager(Builder builder) {
        ...
        mIUpdateHttp = builder.getHttpManager();
    ...
    protected UpdateAppBean fillUpdateAppData() {
        if (mUpdateApp != null) {
            mUpdateApp.setTargetPath(mTargetPath);
            mUpdateApp.setIUpdateHttp(mIUpdateHttp);
    ...
    public void checkNewApp(final UpdateCallback callback) {
        ...
        if (isPost) {
            mIUpdateHttp.asyncPost(mUpdateUrl, params, new IUpdateHttp.Callback() {
                @Override
            ...
            mIUpdateHttp.asyncGet(mUpdateUrl, params, new IUpdateHttp.Callback() {
                @Override
                public void onResponse(String result) {
                    callback.onAfter();
                    if (result != null) {
    ...
    public static class Builder {
        ...
        public IUpdateHttp getHttpManager() {
            return mIUpdateHttp;
        }
         ...
         * 设置网络工具
         *
         * @param IUpdateHttp 自己实现的网络对象
         * @return Builder
         */
        public Builder setHttpManager(IUpdateHttp IUpdateHttp) {
            mIUpdateHttp = IUpdateHttp;
            return this;
        }
